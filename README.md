<img src="icon/logo.png" alt="quorumlogo" width="150"/>
...
- **cmd/quorum-server** - headless CLI server.
- **cmd/quorum-client** - bubbletea chat TUI. Sidebar of channels and DMs, a message viewport, an input line, a status bar with connection state and E2EE key fingerprints.
